exports = async function(changeEvent) {
    ...
    const minBudget = changeEvent.fullDocument.min_budget;
    const maxBudget = changeEvent.fullDocument.max_budget;
  
     if (minBudget > maxBudget) {
      console.log('Error: Minimum budget cannot be greater than maximum budget');
